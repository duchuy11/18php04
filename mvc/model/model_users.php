<?php
	...
	class Model extends ConnectDB{
		...
		function editUser($id,$username,$password,$image) {
			$mysql_edit_user = "UPDATE user SET username = '$username' , password = '$password' , image = '$image' WHERE id = '$id'";
			return mysqli_query($this->conn,$mysql_edit_user);
		}
	}
?>